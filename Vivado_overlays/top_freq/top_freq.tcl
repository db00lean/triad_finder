...
namespace eval ::optrace {
  variable script "Z:/Downloads/max_value/max_value_viv/max_value_viv.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir Z:/Downloads/max_value/max_value_viv/max_value_viv.cache/wt [current_project]
  set_property parent.project_path Z:/Downloads/max_value/max_value_viv/max_value_viv.xpr [current_project]
  set_property ip_repo_paths Z:/Downloads/max_value/max_value_hls [current_project]
  update_ip_catalog
  set_property ip_output_repo Z:/Downloads/max_value/max_value_viv/max_value_viv.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet Z:/Downloads/max_value/max_value_viv/max_value_viv.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files Z:/Downloads/max_value/max_value_viv/max_value_viv.srcs/sources_1/bd/design_1/design_1.bd
