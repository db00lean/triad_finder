...
hls::stream<xfft_axis_t > (&dout))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		std::vector<xfft_axis_t > aesl_tmp_9;
		int aesl_tmp_10;
		int aesl_tmp_11 = 0;
			...
			if (i > 0)
			{
				// RTL Name: dout_V_data
				{
					...
					// {
						...
						// {
							sc_lv<16>* dout_V_data__M_real_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<16>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					// bitslice(31, 16)
					// {
						...
						// {
							sc_lv<16>* dout_V_data__M_imag_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<16>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
    ...
    ap_fixed<16, 1, (ap_q_mode) 5, (ap_o_mode)3, 0> wrap_real_dout_V_data__M_real_V;
						// celement: dout.V.data._M_real.V(15, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								{
									// sub                    : i_0 i_1
									// ori_name               : aesl_tmp_9[i_0].data.real()
									// sub_1st_elem           : 0 0
    ...
    ap_fixed<16, 1, (ap_q_mode) 5, (ap_o_mode)3, 0> wrap_imag_dout_V_data__M_imag_V;
						// celement: dout.V.data._M_imag.V(15, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								{
									// sub                    : i_0 i_1
									// ori_name               : aesl_tmp_9[i_0].data.imag()
									// sub_1st_elem           : 0 0
									// ori_name_1st_elem      : aesl_tmp_9[0].data
			...
			if (i > 0)
			{
				// RTL Name: dout_V_last_V
				{
					...
					// {
						...
						// {
							sc_lv<1>* dout_V_last_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<1>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: dout.V.last.V(0, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									if (&(aesl_tmp_9[0].last) != NULL) // check the null address if the c port is array or others
									{
										aesl_tmp_9[i_0].last = (dout_V_last_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
	...
	else
	{
		...
		std::vector<ap_fixed<16, 1, (ap_q_mode) 5, (ap_o_mode)3, 0> > aesl_tmp_6;
		int aesl_tmp_7 = 0;
		while (!din.empty())
		{
			aesl_tmp_6.push_back(din.read());
			aesl_tmp_7++;
		}
		...
		while (!dout.empty())
		{
			aesl_tmp_9.push_back(dout.read());
			aesl_tmp_10++;
		}
...
// [call_c_dut] ---------->
     ...
     aesl_tmp_9.clear();
		...
		sc_bv<16>* din_V_V_tvin_wrapc_buffer = new sc_bv<16>[aesl_tmp_7 - aesl_tmp_8];
				...
				// celement: din.V.V(15, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						if (&(aesl_tmp_6[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							din_V_V_tmp_mem = (aesl_tmp_6[i_0]).range().to_string(SC_BIN).c_str();
     ...
     {
		sc_int<32> stream_ingress_size_din_V_V = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.din_V_V_depth);
		...
		sc_bv<32>* dout_V_data_tvout_wrapc_buffer = new sc_bv<32>[aesl_tmp_10 - aesl_tmp_11];
    ...
    ap_fixed<16, 1, (ap_q_mode) 5, (ap_o_mode)3, 0> wrap_imag_dout_V_data__M_imag_V;
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.dout_V_data_depth);
		...
		sc_bv<1>* dout_V_last_V_tvout_wrapc_buffer = new sc_bv<1>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].last) != NULL) // check the null address if the c port is array or others
							{
								...
								dout_V_last_V_tmp_mem = (aesl_tmp_9[i_0].last).to_string(2).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.dout_V_last_V_depth);
