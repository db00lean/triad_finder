...
architecture behav of hls_real2xfft is 
    ...
    "hls_real2xfft,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.890000,HLS_SYN_LAT=1032,HLS_SYN_TPT=1024,HLS_SYN_MEM=6,HLS_SYN_DSP=2,HLS_SYN_FF=648,HLS_SYN_LUT=1165,HLS_VERSION=2020_1}";
