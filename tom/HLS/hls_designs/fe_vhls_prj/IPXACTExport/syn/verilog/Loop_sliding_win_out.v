...
wire   [10:0] add_ln83_fu_241_p2;
reg   [10:0] add_ln83_reg_266;
wire   [9:0] empty_fu_247_p1;
reg   [9:0] empty_reg_271;
reg   [0:0] icmp_ln83_reg_296;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln83_reg_296 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln83_reg_296 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i2_0_i_01_reg_187 <= empty_reg_271;
    end else if (((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln83_reg_296 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if (((icmp_ln83_reg_296 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_114)) begin
        if ((icmp_ln83_reg_296 == 1'd1)) begin
            ap_phi_mux_i2_0_i_01_phi_fu_191_p6 = 10'd0;
        end else if ((icmp_ln83_reg_296 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln83_fu_253_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign add_ln83_fu_241_p2 = (11'd2 + i2_0_i_01_cast_fu_221_p1);
...
assign empty_fu_247_p1 = add_ln83_fu_241_p2[9:0];

assign i2_0_i_01_cast_fu_221_p1 = ap_phi_mux_i2_0_i_01_phi_fu_191_p6;

assign icmp_ln83_fu_253_p2 = ((add_ln83_reg_266 == 11'd1024) ? 1'b1 : 1'b0);
