...
wire   [10:0] add_ln69_fu_219_p2;
reg   [10:0] add_ln69_reg_289;
...
reg   [0:0] icmp_ln69_reg_319;
reg   [0:0] icmp_ln69_reg_319_pp0_iter1_reg;
reg   [0:0] icmp_ln69_reg_319_pp0_iter2_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln69_reg_319_pp0_iter2_reg == 1'd1) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln69_reg_319 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_0_017_reg_185 <= empty_7_reg_294;
    end else if (((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln69_reg_319 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if (((icmp_ln69_reg_319_pp0_iter2_reg == 1'd1) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_191)) begin
        if ((icmp_ln69_reg_319 == 1'd1)) begin
            ap_phi_mux_i_0_017_phi_fu_189_p6 = 10'd0;
        end else if ((icmp_ln69_reg_319 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln69_fu_241_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign add_ln69_fu_219_p2 = (11'd2 + zext_ln69_fu_199_p1);
...
assign empty_7_fu_225_p1 = add_ln69_fu_219_p2[9:0];
...
assign icmp_ln69_fu_241_p2 = ((add_ln69_reg_289 == 11'd1024) ? 1'b1 : 1'b0);
...
assign zext_ln69_fu_199_p1 = ap_phi_mux_i_0_017_phi_fu_189_p6;
