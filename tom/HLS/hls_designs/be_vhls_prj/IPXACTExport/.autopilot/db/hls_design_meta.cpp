...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("dout_V_TDATA", 32, hls_out, 2, "axis", "out_data", 1),
	Port_Property("din_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("din_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("ap_start", 1, hls_in, -1, "", "", 1),
	Port_Property("dout_V_TVALID", 1, hls_out, 2, "axis", "out_vld", 1),
	Port_Property("dout_V_TREADY", 1, hls_in, 2, "axis", "out_acc", 1),
