...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (din_TVALID_int == 1'b0) | (ap_done_reg == 1'b1)) & (icmp_ln71_fu_209_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (din_TVALID_int == 1'b0) | (ap_done_reg == 1'b1)) & (icmp_ln71_fu_209_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        val_assign41_reg_141 <= i_fu_191_p2;
    end else if (((~((ap_start == 1'b0) | (din_TVALID_int == 1'b0) | (ap_done_reg == 1'b1)) & (icmp_ln71_fu_209_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        val_assign41_reg_141 <= 9'd0;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (din_TVALID_int == 1'b0) | (ap_done_reg == 1'b1)) & (icmp_ln71_fu_209_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (din_TVALID_int == 1'b0) | (ap_done_reg == 1'b1)) & (tmp_fu_183_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (din_TVALID_int == 1'b0) | (ap_done_reg == 1'b1)) & (tmp_fu_183_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign icmp_ln71_fu_209_p2 = ((val_assign41_reg_141 == 9'd511) ? 1'b1 : 1'b0);

assign tmp_fu_183_p3 = val_assign41_reg_141[32'd0];
