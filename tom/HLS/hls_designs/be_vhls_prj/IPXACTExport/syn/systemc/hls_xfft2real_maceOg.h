...
// ==============================================================
#ifndef __hls_xfft2real_maceOg__HH__
#define __hls_xfft2real_maceOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_xfft2real_maceOg) {
    ...
    SC_CTOR(hls_xfft2real_maceOg):  simcore_mac_0_U ("simcore_mac_0_U") {
