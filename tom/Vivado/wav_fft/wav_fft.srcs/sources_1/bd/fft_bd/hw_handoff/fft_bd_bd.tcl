...
################################################################
# This is a generated script based on design: fft_bd
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net din_V_V_0_1 [get_bd_intf_ports real2xfft_din] [get_bd_intf_pins hls_real2xfft_0/din_V_V]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins hls_real2xfft_0/ap_clk] [get_bd_pins hls_xfft2real_0/ap_clk] [get_bd_pins xfft_0/aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn] [get_bd_pins hls_real2xfft_0/ap_rst_n] [get_bd_pins hls_xfft2real_0/ap_rst_n] [get_bd_pins xfft_0/aresetn]
