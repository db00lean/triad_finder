...
HD_PWD='Z:/FPGA/project/triad_finder/tom/Vivado/wav_fft/wav_fft.runs/fft_bd_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_bd_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_bd_xfft_0_0.tcl
