...
HD_PWD='Z:/FPGA/project/triad_finder/tom/Vivado/wav_fft/wav_fft.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_bd_wrapper.tcl -notrace
