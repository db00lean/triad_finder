...
HD_PWD='Z:/FPGA/project/triad_finder/tom/Vivado/wav_fft/wav_fft.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_bd_wrapper.tcl
