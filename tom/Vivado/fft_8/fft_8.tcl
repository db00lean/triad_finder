...
namespace eval ::optrace {
  variable script "Z:/FPGA/project/triad_finder/tom/Vivado/fft_8bit/fft_8bit.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir Z:/FPGA/project/triad_finder/tom/Vivado/fft_8bit/fft_8bit.cache/wt [current_project]
  set_property parent.project_path Z:/FPGA/project/triad_finder/tom/Vivado/fft_8bit/fft_8bit.xpr [current_project]
  set_property ip_output_repo Z:/FPGA/project/triad_finder/tom/Vivado/fft_8bit/fft_8bit.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet Z:/FPGA/project/triad_finder/tom/Vivado/fft_8bit/fft_8bit.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files Z:/FPGA/project/triad_finder/tom/Vivado/fft_8bit/fft_8bit.srcs/sources_1/bd/design_1/design_1.bd
